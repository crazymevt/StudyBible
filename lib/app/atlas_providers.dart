...
const _eventPlaceOverrides = {
  ...
  // Paul's CuratedPersonJourney: most of Acts' travel narrative packs several
  // place names into one verse (departure, waypoint, and destination all in
  // the same sentence), so without an override here the lowest place-id in
  // that verse would win instead of the place each waypoint is actually
  // named for.
  'Returns to hometown of Tarsus': 'Tarsus',
  'First Journey: Arrives in Perga': 'Perga',
  'First Journey: Heals a cripple in Lystra': 'Lystra',
  'Second Journey: Travels through Syria and Cilicia': 'Syria 2',
  'Second Journey: Returns to Lystra': 'Lystra',
  'Second Journey: Travels through Phrygia': 'Phrygia',
  'Second Journey: Travels through Galatia': 'Galatia',
  'Second Journey: Macedonian call in Troas': 'Troas',
  'Second Journey: Imprisoned in Philippi': 'Philippi',
  'Second Journey: Passes through Apollonia': 'Apollonia',
  'Second Journey: Uproar in Thessalonica': 'Thessalonica',
  'Second Journey: Stays a year and a half in Corinth': 'Corinth',
  'Second Journey: Lands at Caesarea': 'Caesarea',
  'Second Journey: Greets the church in Jerusalem': 'Jerusalem',
  'Third Journey: Strengthens disciples in Galatia': 'Galatia',
  'Third Journey: Three years in Ephesus': 'Ephesus',
  // See the doc comment on this waypoint in curated_journeys_data.dart —
  // Acts 20:2 itself only names "Greece"; this is a deliberate reading.
  'Third Journey: Three months in Greece': 'Corinth',
  'Third Journey: Sails from Philippi': 'Philippi',
  'Third Journey: Revives Eutychus in Troas': 'Troas',
  'Third Journey: Sails to Mitylene': 'Mitylene',
  'Third Journey: Crosses to Samos': 'Samos',
  'Third Journey: Meets Ephesian elders in Miletus': 'Miletus',
  'Third Journey: Sails to Rhodes': 'Rhodes 1',
  'Third Journey: Sails to Patara': 'Patara',
  'Third Journey: Seven days in Tyre': 'Tyre',
  'Journey to Rome: Changes ships in Myra': 'Myra',
  'Journey to Rome: Arrives at Fair Havens': 'Fair Havens',
  'Journey to Rome: Reaches Rhegium': 'Rhegium',
  'Journey to Rome: Met by brothers at Three Taverns': 'Three Taverns',
