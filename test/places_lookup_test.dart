...
void main() {
  ...
  setUp(() async {
    ...
    Future<void> pv(int id, int place, String book, int ch, int v) => store
  ...
  Future<List<PlaceInPassage>> placesFor(String book, int ch) => container.read(
    placesForPassageProvider((book: book, chapter: ch)).future,
  );
