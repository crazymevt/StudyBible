...
void main() {
  test('upgrade from a pre-17 schema does not fail on journals.content_plain', () async {
    ...
    try {
      ...
      await store
          ...
          .get(); // force the lazy open + migrate
  ...
  test('upgrade from the schema-1 destructive path completes cleanly', () async {
